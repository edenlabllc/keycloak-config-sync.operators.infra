...
import (
	...
	"github.com/edenlabllc/keycloak-config-sync.operators.infra/pkg/util"
)
...
func main() {
	...
	if err = keycloakscopemapping.NewReconcile(mgr.GetClient(), h).
		SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create keycloak-scope-mapping controller")
		os.Exit(1)
	}
