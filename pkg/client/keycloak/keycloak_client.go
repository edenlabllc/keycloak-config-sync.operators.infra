...
type KScopeMappings interface {
	SyncRealmScopeMapping(ctx context.Context,
		realmName string,
		scopeID string,
		roles []adapter.RealmRole) error
	DeleteScopeMappingRoles(ctx context.Context,
		realmName string,
		scopeID string,
		roles []adapter.RealmRole) error
}

type KClientScopeMappings interface {
	SyncRealmClientScopeMapping(ctx context.Context,
		fromClientID string,
		realmName string,
		rols []adapter.RealmRole,
		opts adapter.ScopeMappingOptions) error
	DeleteClientScopeMappingRealmRoles(ctx context.Context,
		realmName string,
		fromClientID string,
		opts adapter.ScopeMappingOptions,
		roles []adapter.RealmRole) error
}
