...
const (
	PreserveResourcesOnDeletionAnnotation = "idp.edenlab.io/preserve-resources-on-deletion"
	PreserveResourcesNoDeleteAnnotation   = "idp.edenlab.io/preserve-resources-no-delete"
)
