...
import (
	...
	keycloakAlpha "github.com/edenlabllc/keycloak-config-sync.operators.infra/api/v1alpha1"
	"github.com/edenlabllc/keycloak-config-sync.operators.infra/internal/controller/clusterkeycloakrealm/chain"
...
// +kubebuilder:rbac:groups=v1.edp.edenlab.io,resources=clusterkeycloakrealms,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=v1.edp.edenlab.io,resources=clusterkeycloakrealms/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=v1.edp.edenlab.io,resources=clusterkeycloakrealms/finalizers,verbs=update
