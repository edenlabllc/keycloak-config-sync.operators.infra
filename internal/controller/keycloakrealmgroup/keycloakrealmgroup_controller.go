...
import (
	...
	"github.com/edenlabllc/keycloak-config-sync.operators.infra/internal/controller/keycloakrealmgroup/chain"
...
// +kubebuilder:rbac:groups=v1.edp.edenlab.io,namespace=keycloak,resources=keycloakrealmgroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=v1.edp.edenlab.io,namespace=keycloak,resources=keycloakrealmgroups/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=v1.edp.edenlab.io,namespace=keycloak,resources=keycloakrealmgroups/finalizers,verbs=update
