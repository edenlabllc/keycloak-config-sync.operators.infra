...
import (
	...
	helpermock "github.com/edenlabllc/keycloak-config-sync.operators.infra/internal/controller/helper/mocks"
	"github.com/edenlabllc/keycloak-config-sync.operators.infra/pkg/client/keycloak/adapter"
	"github.com/edenlabllc/keycloak-config-sync.operators.infra/pkg/client/keycloak/mock"
...
func TestReconcile_Reconcile(t *testing.T) {
	...
	var (
		comp = keycloakApi.KeycloakRealmComponent{
			...
			TypeMeta:   metav1.TypeMeta{Kind: "KeycloakRealmComponent", APIVersion: "v1.edp.edenlab.io/v1"},
		...
		realm = keycloakApi.KeycloakRealm{
			TypeMeta: metav1.TypeMeta{
				APIVersion: "v1.edp.edenlab.io/v1", Kind: "KeycloakRealm",
			},
			ObjectMeta: metav1.ObjectMeta{
				Name: "realm1", Namespace: "ns",
