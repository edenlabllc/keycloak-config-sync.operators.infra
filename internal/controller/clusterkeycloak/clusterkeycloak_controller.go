...
// +kubebuilder:rbac:groups=v1.edp.edenlab.io,resources=clusterkeycloaks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=v1.edp.edenlab.io,resources=clusterkeycloaks/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=v1.edp.edenlab.io,resources=clusterkeycloaks/finalizers,verbs=update
