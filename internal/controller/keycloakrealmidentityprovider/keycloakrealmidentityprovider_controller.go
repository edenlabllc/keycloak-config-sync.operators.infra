...
import (
	...
	"github.com/edenlabllc/keycloak-config-sync.operators.infra/internal/controller/keycloakrealmidentityprovider/chain"
...
// +kubebuilder:rbac:groups=v1.edp.edenlab.io,namespace=keycloak,resources=keycloakrealmidentityproviders,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=v1.edp.edenlab.io,namespace=keycloak,resources=keycloakrealmidentityproviders/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=v1.edp.edenlab.io,namespace=keycloak,resources=keycloakrealmidentityproviders/finalizers,verbs=update
