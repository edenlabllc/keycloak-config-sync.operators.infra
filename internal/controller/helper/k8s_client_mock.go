...
import (
	...
	commonmock "github.com/edenlabllc/keycloak-config-sync.operators.infra/pkg/controller-runtime/mock/client"
)
...
func (m *K8SClientMock) GroupVersionKindFor(obj runtime.Object) (schema.GroupVersionKind, error) {
	return m.Called(obj).Get(0).(schema.GroupVersionKind), nil
}

func (m *K8SClientMock) IsObjectNamespaced(obj runtime.Object) (bool, error) {
	return m.Called(obj).Bool(0), nil
}
