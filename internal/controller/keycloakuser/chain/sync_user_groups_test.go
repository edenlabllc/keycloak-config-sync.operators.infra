	...
	tests := []struct {
	...
	}{
		{
			...
			user: &keycloakApiAlpha.KeycloakUser{
				...
				Spec:       keycloakApiAlpha.KeycloakUserSpec{Groups: []string{"developers"}},
			},
		...
		},
		{
			...
			user: &keycloakApiAlpha.KeycloakUser{
				ObjectMeta: metav1.ObjectMeta{Name: "u", Namespace: "default"},
				Spec:       keycloakApiAlpha.KeycloakUserSpec{Groups: []string{"/system/data_admin"}},
			},
		...
		},
		{
			...
			user: &keycloakApiAlpha.KeycloakUser{
				ObjectMeta: metav1.ObjectMeta{Name: "u", Namespace: "default"},
				Spec:       keycloakApiAlpha.KeycloakUserSpec{Groups: []string{"missing-group"}},
			},
		...
		},
		{
			...
			user: &keycloakApiAlpha.KeycloakUser{
				ObjectMeta: metav1.ObjectMeta{Name: "u", Namespace: "default"},
				Spec:       keycloakApiAlpha.KeycloakUserSpec{Groups: []string{"/bad/path"}},
			},
		...
		},
		{
			...
			user: &keycloakApiAlpha.KeycloakUser{
				ObjectMeta: metav1.ObjectMeta{Name: "u", Namespace: "default"},
				Spec:       keycloakApiAlpha.KeycloakUserSpec{Groups: []string{"/missing/path"}},
			},
		...
		},
		{
			...
			user: &keycloakApiAlpha.KeycloakUser{
				ObjectMeta: metav1.ObjectMeta{Name: "u", Namespace: "default"},
				Spec:       keycloakApiAlpha.KeycloakUserSpec{Groups: []string{}},
			},
		...
		},
		{
			...
			user: &keycloakApiAlpha.KeycloakUser{
				ObjectMeta: metav1.ObjectMeta{Name: "u", Namespace: "default"},
				Spec:       keycloakApiAlpha.KeycloakUserSpec{Groups: []string{"developers", "/system/admins"}},
			},
