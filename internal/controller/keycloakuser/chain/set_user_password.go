...
var errSecretKeyNotFound = stderrors.New("secret key not found")
...
func (h *SetUserPassword) updatePasswordCondition(user *keycloakApiAlpha.KeycloakUser, pwdResult *passwordResult) {
...
func (h *SetUserPassword) setPasswordErrorCondition(ctx context.Context, user *keycloakApiAlpha.KeycloakUser, err error) {
	log := ctrl.LoggerFrom(ctx)
...
func (h *SetUserPassword) classifyPasswordError(err error, user *keycloakApiAlpha.KeycloakUser) (reason, message string) {
...
func (h *SetUserPassword) getPassword(ctx context.Context, user *keycloakApiAlpha.KeycloakUser) (*passwordResult, error) {
	log := ctrl.LoggerFrom(ctx)
...
func getPasswordMessage(pwdResult *passwordResult, passwordSecret *keycloakApiAlpha.PasswordSecret) string {
	if !pwdResult.FromSecret {
