...
import (
	...
	"github.com/edenlabllc/keycloak-config-sync.operators.infra/internal/controller/keycloakrealmuser/chain"
...
// +kubebuilder:rbac:groups=v1.edp.edenlab.io,namespace=keycloak,resources=keycloakrealmusers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=v1.edp.edenlab.io,namespace=keycloak,resources=keycloakrealmusers/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=v1.edp.edenlab.io,namespace=keycloak,resources=keycloakrealmusers/finalizers,verbs=update
