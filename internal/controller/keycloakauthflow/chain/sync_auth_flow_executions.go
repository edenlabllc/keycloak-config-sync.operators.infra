...
func NewSyncAuthFlowExecutions(kClient *keycloakv2.KeycloakClient) *SyncAuthFlowExecutions {
...
func (h *SyncAuthFlowExecutions) addExecution(ctx context.Context, realmName, flowID, authenticator, requirement string) (string, error) {
	resp, err := h.kClient.AuthFlows.AddExecutionToFlow(ctx, realmName, keycloakv2.AuthenticationExecutionRepresentation{
