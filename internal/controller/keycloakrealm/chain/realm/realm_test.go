...
import (
	...
	handlermocks "github.com/edenlabllc/keycloak-config-sync.operators.infra/internal/controller/keycloakrealm/chain/realm/handler/mocks"
...
func TestPutRealm_ServeRequest(t *testing.T) {
	...
	keycloakRefSec := "test-keycloak-sec"
	keycloakUrl := "test-keycloak-url"
