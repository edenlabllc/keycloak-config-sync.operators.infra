...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClientAllowedPolicy) DeepCopyInto(out *ClientAllowedPolicy) {
	*out = *in
	if in.Config != nil {
		in, out := &in.Config, &out.Config
		*out = make(map[string][]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClientAllowedPolicy.
func (in *ClientAllowedPolicy) DeepCopy() *ClientAllowedPolicy {
	if in == nil {
		return nil
	}
	out := new(ClientAllowedPolicy)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KeycloakClientSpec) DeepCopyInto(out *KeycloakClientSpec) {
	*out = *in
	...
	if in.ClientScope != nil {
		in, out := &in.ClientScope, &out.ClientScope
		*out = new([]ClientScope)
		if **in != nil {
			in, out := *in, *out
	...
	if in.ClientRegistrationPolicy != nil {
		in, out := &in.ClientRegistrationPolicy, &out.ClientRegistrationPolicy
		*out = new([]ClientAllowedPolicy)
		if **in != nil {
			in, out := *in, *out
			*out = make([]ClientAllowedPolicy, len(*in))
			for i := range *in {
				(*in)[i].DeepCopyInto(&(*out)[i])
			}
		}
...
func (in *KeycloakClientStatus) DeepCopyInto(out *KeycloakClientStatus) {
	*out = *in
	...
	if in.ClientScopeIDs != nil {
		in, out := &in.ClientScopeIDs, &out.ClientScopeIDs
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *KeycloakRealmStatus) DeepCopyInto(out *KeycloakRealmStatus) {
	*out = *in
	...
	if in.AliasIDPs != nil {
		in, out := &in.AliasIDPs, &out.AliasIDPs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
